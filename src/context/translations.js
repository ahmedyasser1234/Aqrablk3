...
export const TRANSLATIONS = {
  ar: {
    ...
    'hero.desc1': 'بانطلاقة جديدة خرجنا خارج نطاق الفكر المحدود لننطلق بك في رحلة مليئة بالإبداع خارج الكوكب.',
    ...
    'page.about.who_title': 'مــن نحــن',
    'page.about.who_p1': 'أقربلك ميديا هي وكالة إبداعية رائدة في مجال الإنتاج الإعلامي والتسويق الرقمي في مصر والعالم العربي. نؤمن بأن كل فكرة تستحق أن تُروى بأسلوب مؤثر، وكل منتج يستحق أن يُعرض بطريقة جذابة.',
    'page.about.who_p2': 'بدأنا رحلتنا برؤية واضحة: تقديم حلول إبداعية متكاملة تجمع بين الجودة الفنية والتأثير التسويقي، لنكون شريكك المثالي في رحلة النجاح وبناء العلامات التجارية المميزة.',
    'page.about.vision_mission_title': 'رؤيتنا ورسالتنا',
    'page.about.vision_title': 'رؤيــتــنــا',
    'page.about.vision_p': 'أن نكون الوجهة الأولى للشركات والعلامات التجارية الراغبة في تحقيق تأثير حقيقي في عالم الإعلام والتسويق الرقمي.',
    'page.about.mission_title': 'رسالـــتـــنـــا',
    'page.about.mission_p': 'تقديم حلول إبداعية مبتكرة تجمع بين الجودة الفنية والاستراتيجية التسويقية لمساعدة عملائنا على تحقيق أهدافهم ونمو أعمالهم.',
    'page.about.why_title': 'لماذا تختار أقربلك ميديا؟',
    'page.about.feat1_title': 'دقة في التنفيذ',
    'page.about.feat1_desc': 'نلتزم بأعلى معايير الجودة في كل مشروع ننفذه.',
    'page.about.feat2_title': 'إبداع لا حدود له',
    'page.about.feat2_desc': 'نقدم أفكاراً مبتكرة تواكب أحدث الاتجاهات العالمية.',
    'page.about.feat3_title': 'شراكة حقيقية',
    'page.about.feat3_desc': 'نعمل كجزء من فريقك لتحقيق النتائج المطلوبة.',

    // Page: Contact Us
    'page.contact.title': 'تواصل معنا',
    'page.contact.subtitle': 'نحن هنا لمساعدتك في تحقيق أهدافك. تواصل معنا الآن لنبدأ رحلة الإبداع معاً.',
    'page.contact.info_title': 'معلومات التواصل',
    'page.contact.phone': 'الهاتف',
    'page.contact.email': 'البريد الإلكتروني',
    'page.contact.address': 'العنوان',
    'page.contact.address_val': 'دكرنس - الدقهلية - مصر',
    'page.contact.hours': 'ساعات العمل',
    'page.contact.hours_days': 'من السبت إلى الخميس',
    'page.contact.hours_val': '9:00 صباحاً - 5:00 مساءً',
    'page.contact.form_title': 'أرسل رسالتك',
    'page.contact.form_name': 'الاسم بالكامل *',
    'page.contact.form_email': 'البريد الإلكتروني *',
    'page.contact.form_phone': 'رقم الهاتف *',
    'page.contact.form_service': 'اختر الخدمة المطلوبة',
  ...
  en: {
    ...
    'page.about.who_title': 'Who We Are',
    'page.about.who_p1': 'Aqrablik Media is a leading creative agency in the field of media production and digital marketing in Egypt and the Arab world. We believe every idea deserves to be told impactfully, and every product deserves to be showcased attractively.',
    'page.about.who_p2': 'We started our journey with a clear vision: to provide integrated creative solutions that combine artistic quality with marketing impact, to be your ideal partner in the journey of success and building distinguished brands.',
    'page.about.vision_mission_title': 'Our Vision & Mission',
    'page.about.vision_title': 'Our Vision',
    'page.about.vision_p': 'To be the primary destination for companies and brands seeking to achieve real impact in the world of media and digital marketing.',
    'page.about.mission_title': 'Our Mission',
    'page.about.mission_p': 'To provide innovative creative solutions that combine technical quality and marketing strategy to help our clients achieve their goals and grow their businesses.',
    'page.about.why_title': 'Why Choose Aqrablik Media?',
    'page.about.feat1_title': 'Execution Precision',
    'page.about.feat1_desc': 'We adhere to the highest quality standards in every project we execute.',
    'page.about.feat2_title': 'Limitless Creativity',
    'page.about.feat2_desc': 'We offer innovative ideas that keep pace with the latest global trends.',
    'page.about.feat3_title': 'True Partnership',
    'page.about.feat3_desc': 'We work as part of your team to achieve the desired results.',

    // Page: Contact Us
    'page.contact.title': 'Contact Us',
    'page.contact.subtitle': 'We are here to help you achieve your goals. Contact us now to start the creative journey together.',
    'page.contact.info_title': 'Contact Information',
    'page.contact.phone': 'Phone',
    'page.contact.email': 'Email',
    'page.contact.address': 'Address',
    'page.contact.address_val': 'Dakarnas - Dakahlia - Egypt',
    'page.contact.hours': 'Working Hours',
    'page.contact.hours_days': 'Saturday to Thursday',
    'page.contact.hours_val': '9:00 AM - 5:00 PM',
    'page.contact.form_title': 'Send Your Message',
    'page.contact.form_name': 'Full Name *',
    'page.contact.form_email': 'Email *',
    'page.contact.form_phone': 'Phone Number *',
    'page.contact.form_service': 'Select Required Service',
