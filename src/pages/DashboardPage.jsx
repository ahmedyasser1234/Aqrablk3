        ...
        <div className="min-h-screen text-white flex overflow-hidden bg-transparent">
            ...
            <aside className={`fixed top-24 ${language === 'ar' ? 'right-0 border-l' : 'left-0 border-r'} h-[calc(100vh-100px)] w-24 lg:w-64 bg-[var(--glass-bg)] backdrop-blur-3xl border-white/10 z-[100] transition-all flex flex-col items-center py-6 overflow-y-auto custom-scrollbar`}>
                ...
                <nav className="flex-1 w-full px-4 space-y-6">
                    <button onClick={() => navigate(`/${lang}/dashboard/stats`)} className={`w-full flex items-center gap-4 p-4 rounded-3xl transition-all ${isStats ? 'text-blue-500 bg-white/5' : 'text-gray-500 hover:text-blue-400'}`}>
                    ...
                    <button onClick={() => navigate(`/${lang}/dashboard/messages`)} className={`w-full flex items-center gap-4 p-4 rounded-3xl transition-all relative ${isMessages ? 'text-blue-500 bg-white/5' : 'text-gray-500 hover:text-blue-400'}`}>
                        <div className="relative">
                    ...
                    <button onClick={() => navigate(`/${lang}/dashboard/requests`)} className={`w-full flex items-center gap-4 p-4 rounded-3xl transition-all relative ${isRequests ? 'text-blue-500 bg-white/5' : 'text-gray-500 hover:text-blue-400'}`}>
                        <div className="relative">
                    ...
                    <button onClick={() => navigate(`/${lang}/dashboard/testimonials`)} className={`w-full flex items-center gap-4 p-4 rounded-3xl transition-all relative ${isTestimonials ? 'text-blue-500 bg-white/5' : 'text-gray-500 hover:text-blue-400'}`}>
                        <div className="relative">
                    ...
                    <button onClick={() => navigate(`/${lang}/dashboard/services`)} className={`w-full flex items-center gap-4 p-4 rounded-3xl transition-all relative ${isServices ? 'text-blue-500 bg-white/5' : 'text-gray-500 hover:text-blue-400'}`}>
                    ...
                    <button onClick={() => navigate(`/${lang}/dashboard/partners`)} className={`w-full flex items-center gap-4 p-4 rounded-3xl transition-all ${isPartners ? 'text-blue-500 bg-white/5' : 'text-gray-500 hover:text-blue-400'}`}>
                    ...
                    {user?.role === 'superadmin' && (
                        <>
                            <button onClick={() => navigate(`/${lang}/dashboard/admins`)} className={`w-full flex items-center gap-4 p-4 rounded-3xl transition-all ${isAdminManagement ? 'text-blue-500 bg-white/5' : 'text-gray-500 hover:text-blue-400'}`}>
                    ...
                    <button onClick={() => navigate(`/${lang}/dashboard/seo`)} className={`w-full flex items-center gap-4 p-4 rounded-3xl transition-all ${isSEO ? 'text-blue-500 bg-white/5' : 'text-gray-500 hover:text-blue-400'}`}>
                    ...
                    <button onClick={() => navigate(`/${lang}/dashboard/blog`)} className={`w-full flex items-center gap-4 p-4 rounded-3xl transition-all ${isBlog ? 'text-blue-500 bg-white/5' : 'text-gray-500 hover:text-blue-400'}`}>
                    ...
                    <button onClick={() => navigate(`/${lang}/dashboard/blog-comments`)} className={`w-full flex items-center gap-4 p-4 rounded-3xl transition-all ${isComments ? 'text-blue-500 bg-white/5' : 'text-gray-500 hover:text-blue-400'}`}>
                    ...
                    <button onClick={() => navigate(`/${lang}/dashboard/chatbot`)} className={`w-full flex items-center gap-4 p-4 rounded-3xl transition-all ${isChatbot ? 'text-blue-500 bg-white/5' : 'text-gray-500 hover:text-blue-400'}`}>
                    ...
                    <button onClick={() => navigate(`/${lang}/dashboard/settings`)} className={`w-full flex items-center gap-4 p-4 rounded-3xl transition-all ${isSettings ? 'text-blue-500 bg-white/5' : 'text-gray-500 hover:text-blue-400'}`}>
                    ...
                    <button onClick={() => navigate(`/${lang}/dashboard/pricing`)} className={`w-full flex items-center gap-4 p-4 rounded-3xl transition-all ${isPricing ? 'text-blue-500 bg-white/5' : 'text-gray-500 hover:text-blue-400'}`}>
