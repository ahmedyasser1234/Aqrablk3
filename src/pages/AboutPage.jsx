    ...
    <div className="pt-24 md:pt-32 px-6 md:px-10 pb-20 overflow-x-hidden">
      ...
      <section className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-20 items-center mb-20 md:mb-32">
          ...
          <div className={`order-1 lg:order-2 ${language === 'ar' ? 'text-right' : 'text-left'}`}>
            <ScrollReveal direction={language === 'ar' ? 'left' : 'right'}>
              <h2 className="text-3xl md:text-5xl font-black mb-6 md:mb-8 text-[var(--text-color)] glow-text">
                {t('page.about.who_title')}
              </h2>
            </ScrollReveal>
            <ScrollReveal delay={0.2} direction={language === 'ar' ? 'left' : 'right'}>
              <p className="text-[var(--text-color)]/70 text-sm md:text-xl leading-loose mb-6 font-light">
                {t('page.about.who_p1')}
              </p>
            </ScrollReveal>
            <ScrollReveal delay={0.4} direction={language === 'ar' ? 'left' : 'right'}>
              <p className="text-[var(--text-color)]/70 text-sm md:text-xl leading-loose font-light">
                {t('page.about.who_p2')}
              </p>
            </ScrollReveal>
          </div>
        ...
        <div className="text-center mb-20 md:mb-32">
          <ScrollReveal>
            <h2 className="text-3xl md:text-5xl font-black mb-12 md:mb-16 text-[var(--text-color)] glow-text">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10">
            ...
            <ScrollReveal direction="right" className="h-full">
              ...
              >
                <div className="p-8 md:p-12 rounded-[2.5rem] bg-transparent backdrop-blur-sm border border-white/5 h-full flex flex-col items-center justify-center text-center hover:bg-white/5 transition-all group relative z-10">
                  ...
                  <p className="text-[var(--text-color)]/70 text-sm md:text-lg font-light leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            <ScrollReveal delay={0.1}>
              <div
                ...
                style={{ '--glow-color': borderColors[0] }}
              >
                <div className="p-8 md:p-10 rounded-[2rem] bg-transparent backdrop-blur-sm border border-white/5 hover:bg-white/5 transition-all text-center h-full relative z-10">
                  <div className="text-5xl mb-6">🎯</div>
                  <h3 className="text-xl md:text-2xl font-bold mb-3 text-[var(--text-color)]">
                    {t('page.about.feat1_title')}
                  </h3>
                  <p className="text-[var(--text-color)]/60 text-sm md:text-base font-light">
